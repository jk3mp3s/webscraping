...
def scrape_sunlife():
    ...
    driver.get("https://sunlife.wd3.myworkdayjobs.com/Experienced-Jobs?q=internship&Location_Country=a30a87ed25634629aa6c3958aa2b91ea")
    time.sleep(5)
    ...
    while True:
        ...
        for card in job_cards:
            ...
            link = "https://sunlife.wd3.myworkdayjobs.com" + partial_link if partial_link.startswith("/") else partial_link
